fill ~-2 ~-3 ~-2 ~2 ~3 ~2 minecraft:flowering_azalea_leaves replace air
fill ~-2 ~-3 ~-2 ~2 ~3 ~2 minecraft:flowering_azalea_leaves replace snow
fill ~-2 ~-3 ~-2 ~2 ~3 ~2 minecraft:flowering_azalea_leaves replace grass
fill ~-1 ~-2 ~-1 ~1 ~2 ~1 air replace flowering_azalea_leaves
